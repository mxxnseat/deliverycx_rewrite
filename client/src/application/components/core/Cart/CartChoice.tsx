...
const CartChoise: FC = () => { 
    ...
    return (
        <div className="cart__choice">
            <div className={deliveryCN} onClick={() => handlerChoice(CART_CHOICE.COURIER)}>Доставка</div>
            <div className={pickupCN} onClick={() => handlerChoice(CART_CHOICE.PICKUP)}>Самовывоз</div>
